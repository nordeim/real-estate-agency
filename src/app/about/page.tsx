  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        {/* The original wraps all about sections in div.pt-32.pb-24 and
            separates the first three with hairline dividers. */}
        <div className="pt-32 pb-24">
          ...
          <section className="py-24 md:py-40 px-[4%] md:px-[2%] max-w-[1400px] mx-auto">
            <div className="text-center mb-16 md:mb-24">
              ...
              <p className="font-body text-sm text-muted-foreground mt-4 max-w-lg mx-auto leading-relaxed">
                ...
                experience and a genuine passion for architecture and
                community.
              </p>
            </div>
          ...
          {/* Parallax image band — original: h-[500px] md:h-[650px],
              divides community impact and the contact CTA. */}
          <ParallaxImage
            src="/media/pages/about-parallax.jpg"
            alt="Luxury property"
            heightClassName="h-[500px] md:h-[650px]"
            wrapperAs="div"
          />

          {/* Contact CTA — original: bordered form card */}
          <section className="py-12 md:py-40 px-[4%] md:px-[2%] max-w-[1400px] mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24">
              <Reveal delay={0.0} duration={0.8}>
                ...
                <p className="font-body text-sm text-muted-foreground leading-relaxed max-w-md">
                  Whether you&apos;re seeking your next residence or
                  considering listing your property, we&apos;re here to guide
                  you with the expertise and discretion you deserve.
                </p>
              </Reveal>
